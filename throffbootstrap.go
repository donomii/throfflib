...
DEFINE VALS => [ MAP2 [ DROP  ] KEYVALS ]
DEFINE KEYS => [ MAP2 [ DROP SWAP ] KEYVALS ]
...
DEFINE ITERATESLICE2 => [

	IF LESSTHAN END  START [ ]
	[

		ITERATESLICE2 MFUNC ADD 2 START END ARRAY1
		STATEMENT [ Internal iterate2 call ] [ CALL MFUNC  UNFUNC GETARRAY START ARRAY1  UNFUNC GETARRAY ADD 1 START ARRAY1 ]
...
DEFINE ITERATE2 => [
	ITERATESLICE2 MFUNC 0 ADD -2 LENGTH ARRAY1 ARRAY1
...
DEFINE MAP2 => [
	returns OUTPUT
	COUNTDOWN2ZERO2
	SUB LENGTH ARRAY1 2 THIN [
		REBIND OUTPUT TOK ARRAYPUSH OUTPUT
			CALL MFUNC UNFUNC GETARRAY SUB 
									SUB 
										LENGTH ARRAY1 
										I 
									2
...
COMMENT [ BIND BASICNAMESPACE =>  ENVIRONMENTOF HERE TOK ]
...
DEFINE COUNTDOWN2ZERO2 => [
	IF LESSTHAN ( COUNT  ZERO )
		[  ]
		[
			COUNTDOWN2ZERO2 ( SUB ( COUNT 2 )  GETFUNCTION ( FUNC TOK ) )
			CALL FUNC COUNT
		]
...
DEFINE NAMETESTBLOCK TOK [ IF RUNTESTS [ TESTBLOCK DROP ] [ DROP DROP ] ]
...
COMMENT [
	...
	COMMENT [ PRINTLN FTYPE EMIT [ TYPE IS: ] ]
...
DEFINE GETFUNC TOK MACRO [ GETFUNCTION ->STRING ] 
